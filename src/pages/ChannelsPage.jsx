        ...
        {isAdmin && (
          <div className="mb-8 text-center">
            <Button 
              ...
              className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 dark:from-purple-500 dark:to-indigo-500 dark:hover:from-purple-600 dark:hover:to-indigo-600 neon-glow text-white"
            >
                  ...
                  <CardContent className="flex-grow flex flex-col justify-end pt-0">
                    ...
                    {isAdmin && (
                      <div className="flex gap-2 mt-3">
                        <Button variant="outline" size="sm" onClick={() => handleOpenDialog(channel)} className="flex-1 text-yellow-400 border-yellow-500/50 hover:bg-yellow-500/10 dark:text-yellow-300 dark:border-yellow-400/50 dark:hover:bg-yellow-400/10">
